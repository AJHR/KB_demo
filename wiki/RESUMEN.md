...
| [valorizacion-inversiones-transmision.md](./valorizacion-inversiones-transmision.md) | Como se valida/valoriza la inversion de una instalacion nueva (linea o subestacion): V.I./A.V.I./COMA, licitacion de obras nuevas, ampliaciones, estudio cuatrienal y rol del Coordinador | LGSE (Arts. 22 trans., 95-97, 108), DS 48 (troncal), DS 144 (subtransmision) |
