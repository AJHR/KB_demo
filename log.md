...
## 2026-05-15
- [vector] Agregado pipeline RAG: `spence-demo-electrico/scripts/process_sources.py` (sources/*.pdf -> chunks -> embeddings -> LanceDB), `query_kb.py` (CLI de busqueda semantica), `run_vector.sh` (wrapper Mac). Modelo `paraphrase-multilingual-MiniLM-L12-v2` (384d). `data/vector/lancedb/` gitignored, `manifest.json` y `README.md` versionados. Pendiente ejecucion en Mac.
